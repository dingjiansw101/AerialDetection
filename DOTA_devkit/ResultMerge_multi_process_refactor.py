...
def mergebypoly(srcpath, dstpath, nms_type='py_cpu_nms_poly_fast3', o_thresh=0.1, h_thresh=0.5):
    """
    srcpath: result files before merge and nms
    dstpath: result files after merge and nms
    """
    ...
    if nms_type == 'py_cpu_nms_poly_fast3':
        mergebase_parallel(srcpath,
                  dstpath,
                  py_cpu_nms_poly_fast3, o_thresh)
    ...
    # mergebase_parallel(srcpath,
    #           dstpath,
    #           py_cpu_nms_poly_fast3, nms_thresh)
