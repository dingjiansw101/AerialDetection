...
static const char __pyx_k_home_dingjian_code_DOTA_devkit[] = "/home/dingjian/code/DOTA_devkit/poly_nms_gpu/poly_overlaps.pyx";
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initpoly_overlaps(void); /*proto*/
PyMODINIT_FUNC initpoly_overlaps(void)
#else
PyMODINIT_FUNC PyInit_poly_overlaps(void); /*proto*/
PyMODINIT_FUNC PyInit_poly_overlaps(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_poly_overlaps(void)", 0);
