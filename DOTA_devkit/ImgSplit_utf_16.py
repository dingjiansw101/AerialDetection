...
if __name__ == '__main__':
    ...
    split = splitbase(r'/home/dingjian/data/GF2_harbor_airport/harbor_airport',
                       r'/home/dingjian/data/GF2_harbor_airport/harbor_airport_2048',
                      code='utf-16',
                      gap=200,
                      subsize=2048,
                      ext='.jpg') ## time cost: 4minute 16s
    # split.splitdata(1)
    # split.splitdata(2)
    split.splitdata(1)