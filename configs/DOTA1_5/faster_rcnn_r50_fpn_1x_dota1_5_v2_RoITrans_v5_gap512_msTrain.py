...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        # score_thr=0.05, nms=dict(type='py_cpu_nms_poly_fast3', iou_thr=0.1), max_per_img=1000)
        score_thr = 0.05, nms = dict(type='py_cpu_nms_poly_fast3', iou_thr=0.1), max_per_img = 2000)
# soft-nms is also supported for rcnn testing
    # e.g., nms=dict(type='soft_nms', iou_thr=0.5, min_score=0.05)
)
# dataset settings
dataset_type = 'DOTA1_5Dataset_v3'
data_root = 'data/dota1_5_1024_v2/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=[data_root + 'trainval1024/DOTA1_5_trainval.json',
                  data_root + 'trainval1024_ms/DOTA1_5_trainval_ms.json'],
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'test1024_ms/DOTA1_5_test1024.json',
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_r50_fpn_1x_dota1_5_v2_RoITrans_v5_gap512_msTrain'
load_from = None
resume_from = None
workflow = [('train', 1)]
