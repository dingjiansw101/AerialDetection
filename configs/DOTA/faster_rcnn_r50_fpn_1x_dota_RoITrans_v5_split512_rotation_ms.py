...
test_cfg = dict(
    ...
    rcnn=dict(
        ...
        # score_thr = 0.001, nms = dict(type='py_cpu_nms_poly_fast3', iou_thr=0.1), max_per_img = 2000)
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_r50_fpn_1x_dota_RoITrans_v5_split512_rotation_ms'
load_from = None
resume_from = None
workflow = [('train', 1)]
