...
# dataset settings
dataset_type = 'DOTA2Dataset_v4'
# TODO: build dota path
data_root = 'data/dota2_1024_v2/'
img_norm_cfg = dict(
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'test-dev1024_ms/DOTA_test-dev1024.json',
        img_prefix=data_root + 'test-dev1024_ms/images',
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_r50_fpn_1x_dota2_v4_RoITrans_v5_gap512_msTrainTest_rotation'
load_from = None
resume_from = None
workflow = [('train', 1)]
